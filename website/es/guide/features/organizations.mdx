...
Las organizaciones son la base de la plataforma Bloque. Pueden ser empresas o DAOs y contienen toda la información de perfil y cumplimiento normativo necesaria.
...
|-------|------|----------|-------------|
| `org_type` | `'business' \| 'dao'` | Sí | Tipo de organización |
...
interface Organization {
  ...
  org_type: 'business' | 'dao';          // Tipo de organización
...
| `active` | La organización está activa | `suspended`, `inactive` |
| `suspended` | La organización está suspendida | `active`, `inactive` |
| `inactive` | La organización está inactiva | - |
