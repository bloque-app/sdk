...
### Cuentas Bancarias US

Bloque expone actualmente dos flujos bancarios de EE.UU. en paralelo durante la transición:

- **`accounts.us`**: cuentas US respaldadas por Bridge con flujo de TOS y `signedAgreementId`
- **`accounts.us2`**: cuentas US respaldadas por Kira con onboarding de cumplimiento y provisión asíncrona de instrucciones bancarias

[Aprende más sobre Cuentas US (Bridge)](/sdk/guide/accounts/us)

[Aprende más sobre Cuentas US2 (Kira)](/sdk/guide/accounts/us2)
...
Obtén el balance actual de cualquier cuenta por URN (válido para card, virtual, bancolombia, breb, us-account, us2-account, polygon):
...
- [Cuentas US (Bridge)](/sdk/guide/accounts/us) - Onboarding de Bridge con TOS
- [Cuentas US2 (Kira)](/sdk/guide/accounts/us2) - Provisión bancaria asíncrona con Kira
