...
:::tip Empieza por una cuenta virtual
Todos los tipos de cuenta de abajo toman su balance de un **ledger**, y una
[cuenta virtual](/sdk/guide/accounts/virtual) es la que lo crea. Créala primero — su `ledgerId`
viene en la respuesta de creación — y luego pasa ese `ledgerId` a cada otra cuenta con la que
quieras compartir el balance. Ver [Ledger y Balance](/sdk/guide/world/ledger) para el concepto.
:::
