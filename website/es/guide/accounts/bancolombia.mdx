...
<QuestHeader
  prereqs={["Cliente SDK conectado", "Identidad con KYC aprobado", "Cuenta virtual base (opcional)"]}
  unlocks={["Cuenta Bancolombia", "referenceCode para recibir pagos en COP"]}
  time="5 min"
/>
