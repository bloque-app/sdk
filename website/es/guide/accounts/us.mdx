...
:::note Flujo específico de Bridge
Esta página documenta el cliente legado `accounts.us` respaldado por Bridge. Para el flujo más nuevo respaldado por Kira sin `getTosLink()` ni `signedAgreementId`, usa [`accounts.us2`](/sdk/guide/accounts/us2).
:::
