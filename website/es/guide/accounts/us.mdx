...
<QuestHeader
  prereqs={["Cliente SDK conectado", "KYC completo aprobado", "Aceptación TOS del usuario (signedAgreementId)"]}
  unlocks={["Cuenta bancaria FDIC-insured en EE.UU.", "Capacidad de transferencia ACH y Wire"]}
  time="10 min"
/>
