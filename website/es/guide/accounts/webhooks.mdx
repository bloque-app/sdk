...
<QuestHeader
  prereqs={["Cuentas activas", "Un endpoint de webhook públicamente accesible"]}
  unlocks={["Eventos del ciclo de vida de cuentas en tiempo real", "Notificaciones de transacciones"]}
/>
