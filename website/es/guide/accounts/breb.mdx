...
- crear una cuenta BRE-B con una llave BRE-B
- asociar la cuenta a un ledger existente cuando envías `ledgerId`, o crear uno automáticamente cuando no lo envías
...
Si envías `ledgerId`, la cuenta BRE-B se asocia a ese ledger. Si no lo envías, el SDK crea uno automáticamente.

Cuando `createKey()` es exitoso, `data` contiene la cuenta BRE-B creada:
