...
| Status | Description |
|--------|-------------|
| `awaiting_compliance_verification` | Pending compliance verification |
| `active` | Organization is active |
| `suspended` | Organization is suspended |
| `closed` | Organization is closed |
...
- [Compliance Guide](/guide/features/compliance) - Add KYC verification
- [Accounts Guide](/guide/accounts/overview) - Create virtual cards and accounts
