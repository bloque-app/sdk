...
Comienza a trabajar con Bloque SDK en minutos.
...
Para usar Bloque SDK, necesitarás una clave API. Puedes obtener una desde el [Panel de Control de Bloque](https://app.bloque.app/settings/api).
...
Siempre envuelve las llamadas del SDK en bloques try-catch para manejar errores adecuadamente:
...
Utiliza variables de entorno para almacenar tu clave API de forma segura:
...
- [Guía de Organizaciones](/guide/features/organizations) - Aprende cómo crear y administrar organizaciones
- [Guía de Cumplimiento](/guide/features/compliance) - Configura la verificación KYC
