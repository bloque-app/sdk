...
| Estado | Descripción |
|--------|-------------|
| `awaiting_compliance_verification` | Verificación pendiente |
...
- [Guía de Cuentas](/guide/accounts/overview) - Crea tarjetas virtuales para usuarios verificados
- [Guía de Organizaciones](/guide/features/organizations) - Administra cuentas empresariales
