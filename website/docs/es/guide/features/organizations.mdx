...
| Estado | Descripción |
|--------|-------------|
| `awaiting_compliance_verification` | Pendiente de verificación de cumplimiento normativo |
| `active` | La organización está activa |
| `suspended` | La organización está suspendida |
...
- [Guía de Cumplimiento Normativo](/guide/features/compliance) - Agrega verificación KYC
- [Guía de Cuentas](/guide/accounts/overview) - Crea tarjetas virtuales y cuentas
