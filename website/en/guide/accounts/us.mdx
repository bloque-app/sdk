...
<QuestHeader
  prereqs={["Connected SDK client", "Full KYC approved", "User TOS acceptance (signedAgreementId)"]}
  unlocks={["FDIC-insured US bank account", "ACH and Wire transfer capability"]}
  time="10 min"
/>
