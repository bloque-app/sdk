...
:::note Bridge-Specific Flow
This page documents the legacy Bridge-backed `accounts.us` client. For the newer Kira-backed flow without `getTosLink()` or `signedAgreementId`, use [`accounts.us2`](/sdk/guide/accounts/us2).
:::
