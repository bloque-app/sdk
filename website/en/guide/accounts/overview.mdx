...
Bloque currently exposes two US banking flows side by side during the transition:

- **`accounts.us`**: Bridge-backed US accounts with a TOS link and `signedAgreementId` flow
- **`accounts.us2`**: Kira-backed US accounts with compliance-driven onboarding and async bank-instruction provisioning

[Learn more about US Accounts (Bridge)](/sdk/guide/accounts/us)

[Learn more about US2 Accounts (Kira)](/sdk/guide/accounts/us2)
...
Get the current balance for any account by URN (works for card, virtual, bancolombia, breb, us-account, us2-account, polygon):
...
- [US Accounts (Bridge)](/sdk/guide/accounts/us) - TOS-driven Bridge onboarding
- [US2 Accounts (Kira)](/sdk/guide/accounts/us2) - Async Kira-backed bank provisioning
