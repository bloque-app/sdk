...
<QuestHeader
  prereqs={["Two or more active accounts", "Sufficient balance in source account"]}
  unlocks={["Funds moved between accounts", "Batch transfer capability"]}
  time="5 min"
/>
...
|--------|-------------|-------------------|
| `queued` | Transfer queued waiting for processing | `processing`, `failed` |
| `processing` | Transfer in progress | `completed`, `failed` |
| `completed` | Transfer completed successfully | - |
...
- [Virtual Cards](/sdk/guide/accounts/cards) - Manage card accounts
- [Bancolombia](/sdk/guide/accounts/bancolombia) - Bancolombia integration
- [Overview](/sdk/guide/accounts/overview) - Accounts overview
