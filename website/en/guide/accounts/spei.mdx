...
Use this pattern to prepare the information needed for activation. The full example is available at `examples/internal-operations/spei/prepare-spei-plugin.ts`.
